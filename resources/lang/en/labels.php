  ...
  [
    ...
    [
      ...
      [
        ...
        'duration' => 'Duration',
        'e3tmad' => 'accreditation body',
        'recording_url' => 'رابط الدورة التزامنيه',
        'goals' => 'Course Goals',
        'requirements' => 'Course Requirements',
        'outputs' => 'Course Ouputs',
        'target_group' => 'Target Group',
        'sponsor_name' => 'This course sponsored by',
        'Asynchronous' => 'Asynchronous',
        'Sync' => 'Sync',
        'bag_type' => 'Course Type',
        'lessons' =>
        [
          'add' => 'Add Lessons',
          'view' => 'View Lessons',
...
<b>Live</b> = Will be used with you Live PayUMoney credentials to make actual transaction with normal users with PayUMoney account.<br><strong>If you set this payment gateway then set your currency as INR</strong>',
    ...
    [
      ...
      [
        'name' => 'Name',
        'code' => 'Coupon Code',
        'adver_name' => 'Advertiser Name',
        'adver_perce' => 'Advertiser Percentage',
        'type' => 'Type',
        'for' => 'For',
        'amount' => 'Amount',
    ...
    [
      'fields' =>
      [
        'first_name' => 'Authorizing authority',
        'last_name' => 'Responsible Person',
        'email' => 'Email Address',
        'password' => 'Password',
        'image' => 'Image',
        'status' => 'Status',
      ...
      'create' => 'Create Accreditation Body',
      'edit' => 'Edit Accreditation Body',
      'view' => 'View Accreditation Bodies',
    ],
    'testimonials' =>
    [
      'fields' =>
    ...
    [
      ...
      [
        ...
        'amount' => 'Total Courses',
        'teachers_name' => 'Teachers',
        'e3tmad' => 'Authorizing authority',
        'amount_tax' => 'Total taxes for courses',
        'certs_price' => 'Total Certificate Fees',
        'certs_total' => 'Number of certificates in fees',
        'certs_price_tax' => 'Total taxes for certificates'
      ],
    ],
    'sitemap' =>
    [
  ...
  [
    ...
    'share_training_needs' => 'Share your training needs',
    'auth' =>
    [
      'login_button' => 'Login',
    ...
    [
      ...
      'certs_price' => 'Certificates Price',
      'cvv' => 'CVV',
      'mm' => 'MM',
      'yy' => 'YY',
      'pay_now' => 'Pay Now',
