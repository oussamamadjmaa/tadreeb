                    ...
                    <div class="card  border-0">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        <label for="gender">{{ html()->label(__('labels.backend.general_settings.user_registration_settings.fields.gender'))->for('password_confirmation') }}</label>
                                        ...
                                        <select id="gender" class="form-control" name="gender" required="" autocomplete="off">
                                            <option value="male"> {{__('validation.attributes.frontend.male')}} </option>
                                            <option value="female"> {{__('validation.attributes.frontend.female')}} </option>
                                        </select>
                                    </div><!--form-group-->
                                </div><!--col-->
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        {{ html()->label('الجنسية')->for('nationality') }}
                                ...
                                <div class="col-md-3 col-6">
                                    <div class="form-group">
                                        <label for="personal_photo"> الصورة الشخصية </label>
                                        <input id="personal_photo" class="form-control" type="file" name="personal_photo" required="" placeholder="الصورة الشخصية">
                                    </div>
                                </div>
                                <div class="col-md-3 col-6">
                                    <div class="form-group">
                                        <label for="passport_photo"> صورة من جواز السفر </label>
                                        <input id="passport_photo" class="form-control" type="file" name="passport_photo" required="" placeholder="صورة من جواز السفر">
                                    </div>
                                </div>
                                <div class="col-md-3 col-6">
                                    <div class="form-group">
                                        <label for="academic_degree_photo"> صورة من آخر مؤهل علمي </label>
                                        <input id="academic_degree_photo" class="form-control" type="file" name="academic_degree_photo" required="" placeholder="صورة من آخر مؤهل علمي">
                                    </div>
                                </div>
                                <div class="col-md-3 col-6">
                                    <div class="form-group">
                                        <label for="cv"> إرفاق السيرة الذاتية </label>
                                        <input id="cv" class="form-control" type="file" name="cv" accept="application/pdf" required="" placeholder="إرفاق السيرة الذاتية">
                                    </div>
                                </div>
