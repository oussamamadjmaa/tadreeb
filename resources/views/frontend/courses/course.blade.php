                    ...
                    <div class="course-details-item border-bottom-0 mb-0">
                        ...
                        <div class="course-single-text">
                            <div class="course-title mt10 headline relative-position">
                                <h4 class="main-text"><a
                                        href="{{ route('courses.show', [$course->slug]) }}"><b>{{ $course->title }}</b></a>
                            ...
                            @if ($course->requirements)
                                <div class="course-title mt10 headline relative-position">
                                    <h4 class="main-text"><b>{{ trans('labels.backend.courses.fields.requirements') }}</b>
                                    </h4>
                                </div>
                                <div class="course-details-content">
                                    {!! $course->requirements !!}
                            ...
                            @if ($course->target_group)
                                <div class="course-title mt10 headline relative-position">
                                    <h4 class="main-text"><b>{{ trans('labels.backend.courses.fields.target_group') }}</b>
                                    </h4>
                                </div>
                                <div class="course-details-content">
                                    {!! $course->target_group !!}
                            ...
                            @if ($course->sponsor_name)
                                <div class="course-title mt10 headline relative-position">
                                    <h4 class="main-text"><b>{{ trans('labels.backend.courses.fields.sponsor_name') }}</b>
                                    </h4>
                                </div>
                                <div class="course-details-content">
                                    {!! $course->sponsor_name !!}
                            ...
                            @if (!$purchased_course)
                                <div class="bg_">
                                    <div class="text-center">
                                        <h5>{{ trans('labels.frontend.course.price') }}</h5>
                                        <h3>
                                            @if ($course->free == 1)
                                    ...
                                    @if (auth()->check() &&
                                        ...
                                        <input type="checkbox" id="inc_certificate_" name="inc_certificate_"
                                            style="float: right;">
                                    @endif
                                    <div class="text-center mb-4">
                                        <h5 style="margin-right: 5px;margin-top: -7px;color: #333;">
                                            <label for="price_certificate" class="d-block">@lang('labels.frontend.course.cert_price')</label>
                                            <span style="color: #4f4d96;">{{ $appCurrency['symbol'] . ' ' . $course->cert_price }}</span>
                                        </h5>
                                    </div>
                                    @if (auth()->check() &&
                                            auth()->user()->hasRole('student') &&
                                        ...
                                        @if ($course->is_expired)
                                            <div class="subs-form relative-position">
                                                <form method="POST" action="{{ route('flagemail', $course->id) }}">
                                                    ...
                                                    <div class="col-md-12">
                                                        <label
                                                            for="email">{{ __('validation.attributes.frontend.email') }}</label>
                                                        ...
                                                        <div class="nws-button text-center  gradient-bg text-uppercase"
                                                            ...
                                                            <button type="submit"
                                                                value="Submit">{{ __('global.flagemail.notify_me') }}</button>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
                                        ...
                                        @else
                                            @if ($course->free == 1)
                                                <form action="{{ route('cart.getnow') }}" method="POST">
                                                    ...
                                                    <input type="hidden" name="inc_certificate" class="inc_certificate"
                                                        value="0">
                                                    <button
                                                        class="genius-btn btn-block text-white  gradient-bg text-center text-uppercase  bold-font"
