    ...
    <nav class="sidebar-nav">
        <ul class="nav">
            ...
            @if($logged_in_user->isAdmin())
                <li class="nav-item ">
                    <a class="nav-link {{ $request->segment(2) == 'training_needs' ? 'active' : '' }}"
                       href="{{ route('admin.training_needs.index') }}">
                        <i class="nav-icon icon-bag"></i>
                        <span class="title">@lang('labels.frontend.training_needs')</span>
                    </a>
                </li>
                <li class="nav-item ">
                    <a class="nav-link {{ $request->segment(2) == 'newsletters' ? 'active' : '' }}"
                       href="{{ route('admin.newsletters.index') }}">
                        <i class="nav-icon icon-bag"></i>
                        <span class="title">@lang('global.Newletter Subscribers')</span>
                    </a>
                </li>
                <li class="nav-item ">
                    <a class="nav-link {{ $request->segment(2) == 'flagemails' ? 'active' : '' }}"
                       href="{{ route('admin.flagemails.index') }}">
                        <i class="nav-icon icon-bag"></i>
                        <span class="title">@lang('global.flagemail.title')</span>
                    </a>
                </li>
                <li class="nav-item ">
                ...
                <li class="nav-item ">
                    <a class="nav-link {{ $request->segment(2) == 'accreditation-bodies' ? 'active' : '' }}"
                       href="{{ route('admin.accreditation-bodies.index') }}">
                        <i class="nav-icon icon-directions"></i>
                        <span class="title">@lang('labels.backend.accreditation-bodies.title')</span>
                    </a>
                </li>
            @endif
                    ...
                    <ul class="nav-dropdown-items">
                        ...
                        <li class="nav-item nav-dropdown">
                            <a class="nav-link nav-dropdown-toggle " href="#">
                                <i class="nav-icon icon-puzzle"></i> {{__('menus.backend.sidebar.Concurrent Lesson Management')}}
                            </a>
                            <ul class="nav-dropdown-items">
