...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-10 form-group">
                    {!! Form::label('e3tmad_id',trans('labels.backend.courses.fields.e3tmad') . ' *', ['class' => 'control-label']) !!}
                    {!! Form::select('e3tmad_id', $e3tmad_list, old('e3tmad_id'), ['class' => 'form-control select2 js-example-placeholder-single', 'multiple' => false, 'required' => true]) !!}
                </div>
            </div>
            <div class="row">
                <div class="col-10 form-group">
            ...
            <div class="row">
                <div class="col-12 col-lg-4 form-group">
                    {!! Form::label('bag_type',trans('labels.backend.courses.fields.bag_type'), ['class' => 'control-label']) !!}
                    {!! Form::select('bag_type', [
                        1 => trans('labels.backend.courses.fields.Asynchronous'),
                        2 => trans('labels.backend.courses.fields.Sync')
                    ], old('bag_type'), ['class' => 'form-control select2 js-example-placeholder-single', 'multiple' => false, 'required' => true]) !!}
                </div>
                <div class="col-12 col-lg-4 form-group">
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-6 form-group">
                    {!! Form::label('cert_price',  trans('labels.backend.courses.fields.cert_price').' (in '.$appCurrency["symbol"].')', ['class' => 'control-label']) !!}
                    {!! Form::number('cert_price', old('cert_price'), ['class' => 'form-control', 'placeholder' => trans('labels.backend.courses.fields.cert_price'),'step' => 'any', 'pattern' => "[0-9]"]) !!}
                </div>
                <div class="col-12 col-lg-6 form-group">
                    {!! Form::label('cert_image',  trans('labels.backend.courses.fields.cert_image'), ['class' => 'control-label']) !!}
                    {!! Form::file('cert_image',  ['class' => 'form-control', 'accept' => 'image/jpeg,image/gif,image/png']) !!}
                    {!! Form::hidden('cert_image_max_size', 8) !!}
                    {!! Form::hidden('cert_image_max_width', 4000) !!}
                    {!! Form::hidden('cert_image_max_height', 4000) !!}
                    @if ($course->cert_image)
                        <a href="{{ asset('storage/uploads/'.$course->cert_image) }}" target="_blank"><img
                                    height="50px" src="{{ asset('storage/uploads/'.$course->cert_image) }}"
                                    class="mt-1"></a>
                    @endif
                </div>
            </div>
            @php
                $cert_data = (object)($course->cert_data);
            @endphp
                <div class="card">
                    <div class="card-header">
                        <label for="custom_cert" class="control-label font-weight-bold">تخصيص الشهادة</label>
                        <span class="help-text font-italic">في حالة لم تخصص سيتم التعامل مع التخصيص المحدد في الاعدادت</span>
                    </div>
                    <div class="row card-body">
                        <div class="col-12 col-lg-2 form-group checkbox d-inline">
                            <input name="show_e3tmad" type="checkbox" @if ($cert_data->show_e3tmad ?? '') checked="checked" @endif>
                            <label for="show_e3tmad" class="checkbox control-label font-weight-bold">إظهار جهة الاعتماد</label>
                        </div>
                        <div class="col-12 col-lg-2 form-group">
                            <label for="cert_text1" class="control-label">السطر الاول</label>
                            <input class="form-control" placeholder="السطر الاول" name="cert_data[text_1]" type="text" value="{{$cert_data->text_1 ?? ''}}" id="cert_text1">
                        </div>
                        <div class="col-12 col-lg-2 form-group">
                            <label for="cert_text2" class="control-label">السطر الثاني</label>
                            <input class="form-control" placeholder="السطر الثاني" name="cert_data[text_2]" type="text" value="{{$cert_data->text_2 ?? ''}}" id="cert_text2">
                        </div>
                        <div class="col-12 col-lg-2 form-group">
                            <label for="cert_text3" class="control-label">السطر الثالث</label>
                            <input class="form-control" placeholder="السطر الثالث" name="cert_data[text_3]" type="text" value="{{$cert_data->text_3 ?? ''}}" id="cert_text3">
                        </div>
                        <div class="col-12 col-lg-2 form-group">
                            <label for="cert_text4" class="control-label">السطر الرابع</label>
                            <input class="form-control" placeholder="السطر الرابع" name="cert_data[text_4]" type="text" value="{{$cert_data->text_4 ?? ''}}" id="cert_text4">
                        </div>
                        <div class="col-12 col-lg-2 form-group">
                            <label for="cert_text5" class="control-label">السطر الخامس</label>
                            <input class="form-control" placeholder="السطر الخامس" name="cert_data[text_5]" type="text" value="{{$cert_data->text_5 ?? ''}}" id="cert_text5">
                        </div>
                    </div>
                </div>
            <div class="row">
                ...
                @endif
                <div class="col-12 col-lg-4 form-group">
                    {!! Form::label('level', trans('labels.backend.courses.fields.level'), ['class' => 'control-label']) !!}
                    {!! Form::text('level', old('level'), ['class' => 'form-control', 'placeholder' => trans('labels.backend.courses.fields.level'), 'required' => false]) !!}
                </div>
                <div class="col-12 col-lg-4 form-group">
                    {!! Form::label('voltage', trans('labels.backend.courses.fields.voltage'), ['class' => 'control-label']) !!}
                    {!! Form::text('voltage', old('voltage'), ['class' => 'form-control', 'placeholder' => trans('labels.backend.courses.fields.voltage'), 'required' => false]) !!}
                </div>
                <div class="col-12 col-lg-4 form-group">
                    {!! Form::label('duration', trans('labels.backend.courses.fields.duration'), ['class' => 'control-label']) !!}
                    {!! Form::text('duration', old('duration'), ['class' => 'form-control', 'placeholder' => trans('labels.backend.courses.fields.duration'), 'required' => false]) !!}
                </div>
                <div class="col-12 col-lg-4 form-group">
                    {!! Form::label('recording_url', trans('labels.backend.courses.fields.recording_url'), ['class' => 'control-label']) !!}
                    {!! Form::text('recording_url', old('recording_url'), ['class' => 'form-control', 'placeholder' => trans('labels.backend.courses.fields.recording_url'), 'required' => false]) !!}
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-12 form-group">
                    {!! Form::label('goals',  trans('labels.backend.courses.fields.goals'), ['class' => 'control-label']) !!}
                    {!! Form::textarea('goals', old('goals'), ['class' => 'form-control editor', 'placeholder' => trans('labels.backend.courses.fields.goals')]) !!}
                </div>
                <div class="col-12 form-group">
                    {!! Form::label('requirements',  trans('labels.backend.courses.fields.requirements'), ['class' => 'control-label']) !!}
                    {!! Form::textarea('requirements', old('requirements'), ['class' => 'form-control editor', 'placeholder' => trans('labels.backend.courses.fields.requirements')]) !!}
                </div>
                <div class="col-12 form-group">
                    {!! Form::label('outputs',  trans('labels.backend.courses.fields.outputs'), ['class' => 'control-label']) !!}
                    {!! Form::textarea('outputs', old('outputs'), ['class' => 'form-control editor', 'placeholder' => trans('labels.backend.courses.fields.outputs')]) !!}
                </div>
                <div class="col-12 form-group">
                    {!! Form::label('target_group',  trans('labels.backend.courses.fields.target_group'), ['class' => 'control-label']) !!}
                    {!! Form::textarea('target_group', old('target_group'), ['class' => 'form-control editor', 'placeholder' => trans('labels.backend.courses.fields.target_group')]) !!}
                </div>
                <div class="col-12 form-group">
                    {!! Form::label('sponsor_name',  trans('labels.backend.courses.fields.sponsor_name'), ['class' => 'control-label']) !!}
                    {!! Form::textarea('sponsor_name', old('sponsor_name'), ['class' => 'form-control editor', 'placeholder' => trans('labels.backend.courses.fields.sponsor_name')]) !!}
                </div>
                <div class="col-12 form-group">
