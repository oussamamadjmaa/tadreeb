...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="row form-group">
                {{ html()->label(__('labels.backend.coupons.fields.adver_perce'))->class('col-md-2 form-control-label')->for('adver_perce') }}

                <div class="col-md-10">
                    {{ html()->input('number','adver_perce')
                    ->placeholder(__('labels.backend.coupons.fields.adver_perce'))
                        ->class('form-control')
                    }}
                </div><!--col-->
            </div>
            <div class="row form-group">
                {{ html()->label(__('labels.backend.coupons.fields.adver_name'))->class('col-md-2 form-control-label')->for('adver_name') }}

                <div class="col-md-10">
                    {{ html()->text('adver_name')
                        ->class('form-control')
                        ->placeholder(__('labels.backend.coupons.fields.adver_name'))
                    }}
