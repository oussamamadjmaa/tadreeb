                    ...
                    <div class="card">
                        ...
                        <div class="row card-body">
                            ...
                            <div class="col-12 col-lg-2 form-group">
                                ...
                                <input class="form-control" placeholder="السطر الاول" required="" name="cert_data[text_1]" type="text" value="{{$cert_data->text_1}}" id="cert_text1">
                            </div>
                            <div class="col-12 col-lg-2 form-group">
                                <label for="cert_text2" class="control-label">السطر الثاني</label>
                                <input class="form-control" placeholder="السطر الثاني" required="" name="cert_data[text_2]" type="text" value="{{$cert_data->text_2}}" id="cert_text2">
                            </div>
                            <div class="col-12 col-lg-2 form-group">
                                <label for="cert_text3" class="control-label">السطر الثالث</label>
                                <input class="form-control" placeholder="السطر الثالث" required="" name="cert_data[text_3]" type="text" value="{{$cert_data->text_3}}" id="cert_text3">
                            </div>
                            <div class="col-12 col-lg-2 form-group">
