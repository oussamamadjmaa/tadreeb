                ...
                <div class="col-12">
                    ...
                    <div class="row mb-4">
                        <div class="col-6">
                            ...
                            <input type="text" class="form-control datetimepicker fromDate">
                        </div>
                        <div class="col-6">
                            <label>إلى تاريخ:</label>
                            <input type="text" class="form-control datetimepicker toDate">
                        </div>
                    </div>
                    <div class="table-responsive">
                        <table id="myCourseTable" class="table table-bordered table-striped ">
                            ...
                            <tr>
                                ...
                                <th>@lang('labels.backend.reports.fields.teachers_name')</th>
                                <th>@lang('labels.backend.reports.fields.e3tmad')</th>
                                ...
                                <th>@lang('labels.backend.reports.fields.amount_tax') <span style="font-weight: lighter">(in {{$appCurrency['symbol']}})</span></th>
                                <th>@lang('labels.backend.reports.fields.certs_price') <span style="font-weight: lighter">(in {{$appCurrency['symbol']}})</span></th>
                                <th>@lang('labels.backend.reports.fields.certs_total')</th>
                                <th>@lang('labels.backend.reports.fields.certs_price_tax') <span style="font-weight: lighter">(in {{$appCurrency['symbol']}})</span></th>
                            </tr>
                            </thead>
...
<script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
    ...
    <link rel="stylesheet" href="https://test.al-modareb.com/js/datetimepicker/jquery.datetimepicker.css">
    <script src="https://test.al-modareb.com/js/datetimepicker/jquery.datetimepicker.js" type="text/javascript"></script>
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#myCourseTable').DataTable({
                ...
                columns: [
                    ...
                    {data: "e3tmad", name: 'e3tmad'},
                    {data: "item_count", name: 'item_count'},
                    {data: "item_sum_price", name: 'item_sum_price'},
                    {data: "item_sum_price_tax", name: 'item_sum_price_tax'},
                    {data: "item_sum_cert_price", name: 'item_sum_cert_price'},
                    {data: "certificates_count", name: 'certificates_count'},
                    {data: "item_sum_cert_price_tax", name: 'item_sum_cert_price_tax'},
                ],
