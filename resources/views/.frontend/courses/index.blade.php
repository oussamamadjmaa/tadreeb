                                ...
                                <div class="featured-course">
                                    <div class="best-course-pic-text relative-position pt-0">
                                        ...
                                        <div class="best-course-text">
                                            ...
                                            <img width="100%" class="avatar" src="{{$global_featured_course->teachers->first()->picture}}" alt="Teacher">
                                            <div class="row text-center">
                                                <div class="col-12 mb-2 textZoom">
                                                    <a href="#">
                                                        <span style="font-weight: bolder">{{$global_featured_course->teachers->first()->name}}</span>
                                                    </a>
                                                    </div>
                                                    <div class="col-12 mb-1 d-inline-flex text-center">
                                                        <div class="col-5 border border-dark rounded bg-theme-color">
                                                        ...
                                                        <div class="col-7 border border-dark rounded p-0">
                                                            <a href="{{ route('courses.show', [$global_featured_course->slug]) }}">
                                                                <span class="card-info">{{$global_featured_course->title}}</span>
                                                            </a>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 mb-1 d-inline-flex text-center">
                                                        ...
                                                        <div class="col-7 border border-dark rounded p-0">
                                                            <span class="card-info">{{$global_featured_course->bag_type_text}}</span>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 mb-1 d-inline-flex text-center">
                                                        <div class="col-5 border border-dark rounded bg-theme-color">
                                                        ...
                                                        <div class="col-7 border border-dark rounded p-0">
                                                            <span class="card-info">{{$global_featured_course->e3tmad->first_name ?? __('global.without')}}</span>
                                                        </div>
                                                    </div>
                                            </div>
                                            <div class="course-meta">
                                                <div class="course-viewer ul-li">
                                                    <ul>
                                                        <li>
                                                            <a href="#" class="text-dark"><i class="fas fa-user"></i> {{ $global_featured_course->students()->count() }}</a>
                                                        </li>
                                                        <li>
                                                            <a href="#" class="text-dark"><i class="fas fa-comment-dots"></i> {{$global_featured_course->reviews()->count()}}</a>
                                                        </li>
                                                    </ul>
                                                </div>
