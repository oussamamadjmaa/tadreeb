...
@if($footer_data != "")
<footer>
    <section id="footer-area" class="footer-area-section" style="padding-top:2.1rem;">
        <div class="container">
        ...
        @if($footer_data->bottom_footer->status == 1)
                    <div class="copy-right-menu" style="padding:15px 0 0 0;background: #5c54a0  none repeat scroll 0 0;">
                        <div class="row" style="margin-left:0; margin-right:0;">
                            ...
                            @endif
                            @if(($footer_data->bottom_footer_links->status == 1))
                                <div class="col-md-6">
                                    <div class="copy-right-menu-item float-right ul-li">
                                        <ul>
                                            @if ((count($footer_data->bottom_footer_links->links) > 0))
