            ...
            <div class="modal-content">
                ...
                <div class="modal-header backgroud-style">
                    ...
                    <div class="popup-text text-center">
                        ...
                        <p><p> <a href="#" class="btn bg-theme-color mr-1 go-register" id=""> {{trans('labels.frontend.modal.register_now')}} </a> <a href="#" class="btn btn-dark go-login"> {{trans('navs.frontend.login')}} </a></p></p>
                    </div>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane container fade" id="register">
                            ...
                            <form id="registerForm" class="contact_form"
                                ...
                                @if(config('registration_fields') != NULL)
                                    ...
                                    @foreach($fields as $item)
                                        @if(in_array($item->type,$inputs))
                                            <div class="contact-info mb-2">
                                                @if ($item->name == "phone")
                                                <input type="text" class="form-control mb-0" id="phone" value="{{old($item->name)}}" name="{{$item->name}}"
                                ...
                                @endif
                                {{-- <div class="contact-info mb-2">
                                        <select id="academicRank" class="form-control mb-0" name="academic_rank" required="" autocomplete="off">
                                        ...
                                        <span id="academicRank-error" class="text-danger"></span>
                                </div>       --}}
                                @if(config('access.captcha.registration'))
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (data.errors) {
                                ...
                                if (data.errors.academic_rank) {
                                    $('#academicRank-error').html(data.errors.academic_rank[0]);
                                }
