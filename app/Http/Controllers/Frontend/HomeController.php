...
use App\Notifications\Frontend\NewlatterSubscribeNotification;
...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.index-' . config('theme_layout'), compact('popular_courses', 'featured_courses', 'sponsors', 'total_students', 'total_courses', 'total_teachers', 'testimonials', 'news', 'trending_courses', 'teachers', 'faqs', 'course_categories', 'reasons', 'sections','categories'));
    }
    ...
    public function subscribe(Request $request)
    {
        $this->validate($request, [
            'subs_email' => 'required|email:dns|unique:newslatters,email'
        ]);
        $newslatter = Newslatters::create(['email' => $request->subs_email]);
        Notification::route('mail', $request->subs_email)
                        ->notifyNow(new NewlatterSubscribeNotification($newslatter));
        return back();
    ...
    public function unsubscribe($id, $email){
        $newslatter = Newslatters::where('email', $email)->findOrFail($id);
        $newslatter->delete();
    ...
    {
        $recent_news = Blog::orderBy('created_at', 'desc')->take(3)->get();
    ...
    public function showTeacher(Request $request)
    {
        ...
        return view('frontend.teachers.show', compact('teacher', 'recent_news', 'courses'));
    }
