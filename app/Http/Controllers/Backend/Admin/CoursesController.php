...
class CoursesController extends Controller
{
    ...
    public function getData(Request $request)
    {
        ...
        }elseif (request('e3tmad_id') != "") {
            $id = request('e3tmad_id');
            $courses = Course::query()->ofE3tmad()
                ->whereHas('category')
                ->whereHas('e3tmads', function ($q) use ($id) {
                    $q->where('e3tmad_id', '=', $id);
                })->orderBy('created_at', 'desc');
    ...
    public function create()
    {
        ...
        $e3tmad_list = User::where('user_type', '=', 'e3tmad')->pluck('first_name', 'id');

        return view('backend.courses.create', compact('teachers', 'categories', 'e3tmad_list'));
    }
...
//                }
    ...
    public function edit($id)
    {
        ...
        return view('backend.courses.edit', compact('course', 'teachers', 'categories', 'e3tmad_list'));
    }
    ...
    public function update(UpdateCoursesRequest $request, $id)
    {
        ...
        if($request->cert_data['text_1']){
            $cert_data = $request->cert_data;
            $cert_data['show_e3tmad'] = (isset($request->show_e3tmad)) ? 1 : 0;
            $course->cert_data = $cert_data;
            
        }else{
            $course->cert_data = NULL;
        }
