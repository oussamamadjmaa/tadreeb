...
{    public function all()
    ...
    public function show($bundle_slug)
    {
        ...
        return view( 'frontend.bundles.show', compact('bundle', 'purchased_bundle', 'recent_news', 'bundle_rating','bundle_rating','courses','total_ratings','is_reviewed','checkSubcribePlan','bundleInPlan'));
    }
