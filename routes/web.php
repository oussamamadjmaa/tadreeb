...
Route::get('newsletter/unsubscribe/{id}/{email}', 'Frontend\HomeController@unsubscribe')->name('unsubscribe');
...
Route::post('course/{course}/flagemail', 'CoursesController@flagemail')->name('flagemail');
