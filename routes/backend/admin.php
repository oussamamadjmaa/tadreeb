...
Route::group(['middleware' => 'role:administrator'], function () {
    Route::resource('training_needs', TrainingNeedsController::class)->only(['index', 'show', 'destroy']);
    Route::resource('newsletters', NewslettersController::class)->only(['index', 'create', 'store']);

    Route::resource('flagemails', FlagemailsController::class)->only(['index', 'create', 'store']);
    ...
    //===== E3tmad Routes =====//
    Route::resource('accreditation-bodies', 'Admin\E3tmadController')->except(['show']);
    Route::get('get-accreditation-bodies-data', ['uses' => 'Admin\E3tmadController@getData', 'as' => 'accreditation-bodies.get_data']);
    Route::post('accreditation-bodies_mass_destroy', ['uses' => 'Admin\E3tmadController@massDestroy', 'as' => 'accreditation-bodies.mass_destroy']);
    Route::post('accreditation-bodies_restore/{id}', ['uses' => 'Admin\E3tmadController@restore', 'as' => 'accreditation-bodies.restore']);
    Route::delete('accreditation-bodies_perma_del/{id}', ['uses' => 'Admin\E3tmadController@perma_del', 'as' => 'accreditation-bodies.perma_del']);
    Route::post('accreditation-body/status', ['uses' => 'Admin\E3tmadController@updateStatus', 'as' => 'accreditation-bodies.status']);
...
Route::group(['middleware' => 'role:administrator|teacher'], function () {
    ...
    Route::get('report/students-list/{course}', ['uses' => 'ReportController@showStudents', 'as' => 'reports.show_students']);
    Route::post('report/students-msg', ['uses' => 'ReportController@msgStudents', 'as' => 'reports.msg_students']);
    ...
    Route::get('report/students-list/{course}/get', ['uses' => 'ReportController@getStudents', 'as' => 'reports.get_students']);
