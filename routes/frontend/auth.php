...
use App\Http\Controllers\Frontend\Auth\AccreditationBodyRegisterController;
...
Route::group(['namespace' => 'Auth', 'as' => 'auth.'], function () {
    ...
    */
    ...
    Route::group(['middleware' => 'guest'], function () {
        ...
        // New Register Accreditation Body Routes
        Route::get('accreditation-body/register',[AccreditationBodyRegisterController::class, 'showAccreditationBodyRegistrationForm'])->name('accreditation-body.register');
        Route::post('accreditation-body/register', [AccreditationBodyRegisterController::class, 'register'])->name('accreditation-body.register.post');
